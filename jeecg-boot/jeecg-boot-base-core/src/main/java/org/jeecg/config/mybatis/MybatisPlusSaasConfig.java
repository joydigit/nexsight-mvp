...
@Slf4j
@Configuration
@MapperScan(value={"org.jeecg.**.mapper*","com.joydigit.seniorcaring.mvp.**.mapper"})
public class MybatisPlusSaasConfig {
    ...
    static {
        ...
        if (MybatisPlusSaasConfig.OPEN_SYSTEM_TENANT_CONTROL) {
            ...
            TENANT_TABLE.add("elder_assessment");
            TENANT_TABLE.add("elder_bed");
            TENANT_TABLE.add("elder_bill");
            TENANT_TABLE.add("elder_bill_detail");
            TENANT_TABLE.add("elder_building");
            TENANT_TABLE.add("elder_consulting_follow_record");
            TENANT_TABLE.add("elder_customer");
            TENANT_TABLE.add("elder_customer_account");
            TENANT_TABLE.add("elder_customer_checkin");
            TENANT_TABLE.add("elder_customer_checkin_fee");
            TENANT_TABLE.add("elder_customer_family");
            TENANT_TABLE.add("elder_customer_outing_record");
            TENANT_TABLE.add("elder_customer_payment");
            TENANT_TABLE.add("elder_customer_visiting_record");
