 ...
 */
@Data
@TableName("elder_project_user")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="elder_project_user")
public class ElderProjectUser implements Serializable {
	...
	/**Jeecg系统用户ID（逻辑外键）*/
	@Excel(name = "Jeecg系统用户ID（逻辑外键）", width = 15)
    @Schema(description = "Jeecg系统用户ID（逻辑外键）")
