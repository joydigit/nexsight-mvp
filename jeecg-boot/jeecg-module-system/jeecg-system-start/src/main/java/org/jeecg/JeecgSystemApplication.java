...
*/
@Slf4j
@SpringBootApplication(exclude = MongoAutoConfiguration.class,scanBasePackages = {"org.jeecg","com.joydigit.seniorcaring.mvp"})
...
public class JeecgSystemApplication extends SpringBootServletInitializer {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        log.info("\n----------------------------------------------------------\n\t" +
                "Application 悦享机构养老SAAS平台 is running! Access URLs:\n\t" +
