<template>
  <div class="p-2">
    ...
    <!-- 表单区域 -->
    <ElderBillDetailModal ref="registerModal" @success="handleSuccess"></ElderBillDetailModal>
  </div>
</template>

<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderBillDetail" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns, superQuerySchema } from './ElderBillDetail.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderBillDetail.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import ElderBillDetailModal from './components/ElderBillDetailModal.vue'
