<template>
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'elder_building:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <ElderBuildingModal ref="registerModal" @success="handleSuccess"></ElderBuildingModal>
  </div>
</template>
...
<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderBuilding" setup>
  ...
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderBuilding.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import ElderBuildingModal from './components/ElderBuildingModal.vue'
