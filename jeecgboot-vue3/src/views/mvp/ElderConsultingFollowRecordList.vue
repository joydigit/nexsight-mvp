...
<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderConsultingFollowRecord" setup>
  ...
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderConsultingFollowRecord.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import ElderConsultingFollowRecordModal from './components/ElderConsultingFollowRecordModal.vue'
  ...
  const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
    tableProps: {
      title: 'elder_consulting_follow_record',
      api: list,
      columns,
      canResize:true,
      useSearchForm: false,
    ...
    exportConfig: {
      name: "elder_consulting_follow_record",
      url: getExportUrl,
      params: queryParam,
    },
	  importConfig: {
