<template>
  <div class="p-2">
    ...
    <!-- 表单区域 -->
    <ElderCustomerCheckinFeeModal ref="registerModal" @success="handleSuccess"></ElderCustomerCheckinFeeModal>
  </div>
</template>
...
<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderCustomerCheckinFee" setup>
  ...
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderCustomerCheckinFee.api';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import ElderCustomerCheckinFeeModal from './components/ElderCustomerCheckinFeeModal.vue'
  ...
  const { prefixCls, tableContext, onExportXls, onImportXls } = useListPage({
    tableProps: {
      title: 'elder_customer_checkin_fee',
      api: list,
      columns,
      canResize:true,
      useSearchForm: false,
    ...
    exportConfig: {
      name: "elder_customer_checkin_fee",
      url: getExportUrl,
      params: queryParam,
    },
	  importConfig: {
