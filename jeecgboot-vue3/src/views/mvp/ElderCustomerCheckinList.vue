  ...
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <a-button  type="primary" v-auth="'elder_customer_checkin:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
        <j-upload-button  type="primary" v-auth="'elder_customer_checkin:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
    ...
    return [
      {
        ...
        auth: 'com.joydigit.seniorcaring.mvp:elder_customer_checkin:edit'
      },
    ];
  }
    ...
    return [
      {
        ...
        auth: 'com.joydigit.seniorcaring.mvp:elder_customer_checkin:delete'
      }
    ]
  }
