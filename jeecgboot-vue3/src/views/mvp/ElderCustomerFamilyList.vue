<template>
  <div class="p-2">
    ...
    <!-- 表单区域 -->
    <ElderCustomerFamilyModal ref="registerModal" @success="handleSuccess"></ElderCustomerFamilyModal>
  </div>
</template>

<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderCustomerFamily" setup>
  import { ref, reactive } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useListPage } from '/@/hooks/system/useListPage';
  import { columns, superQuerySchema } from './ElderCustomerFamily.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderCustomerFamily.api';
