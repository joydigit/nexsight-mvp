  ...
  <div class="p-2">
        ...
        <a-row :gutter="24">
          <a-col :lg="6">
            <a-form-item name="projectId">
              <template #label><span title="所属项目ID">所属项目</span></template>
              <a-input placeholder="请输入所属项目ID" v-model:value="queryParam.projectId" allow-clear ></a-input>
            </a-form-item>
          </a-col>
          <a-col :lg="6">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <a-button  type="primary" v-auth="'elder_customer:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
        <j-upload-button  type="primary" v-auth="'elder_customer:importExcel'"  preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
    ...
    return [
      {
        ...
        auth: 'com.joydigit.seniorcaring.mvp:elder_customer:edit'
      },
    ];
  }
    ...
    return [
      {
        ...
        auth: 'com.joydigit.seniorcaring.mvp:elder_customer:delete'
      }
    ]
  }
