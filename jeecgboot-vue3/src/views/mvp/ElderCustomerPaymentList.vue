...
<script lang="ts" name="com.joydigit.seniorcaring.mvp-elderCustomerPayment" setup>
  ...
  import { columns, superQuerySchema } from './ElderCustomerPayment.data';
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './ElderCustomerPayment.api';
