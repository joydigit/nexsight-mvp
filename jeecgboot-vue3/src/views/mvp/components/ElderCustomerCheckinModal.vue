<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <ElderCustomerCheckinForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></ElderCustomerCheckinForm>
   <template #footer>
...
<script lang="ts" setup>
  ...
  import ElderCustomerCheckinForm from './ElderCustomerCheckinForm.vue'
