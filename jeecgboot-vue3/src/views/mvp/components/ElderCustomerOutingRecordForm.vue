        ...
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="ElderCustomerOutingRecordForm">
          <a-row>
            ...
            <a-col :span="24">
						...
						<a-col :span="24">
							<a-form-item label="结束时间" v-bind="validateInfos.endTime" id="ElderCustomerOutingRecordForm-endTime" name="endTime">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../ElderCustomerOutingRecord.api';
