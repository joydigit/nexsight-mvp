          ...
          <a-row>
            <a-col :span="24">
                ...
                />
						...
						<a-col :span="24">
							<a-form-item label="楼层名称" v-bind="validateInfos.floorName" id="ElderFloorForm-floorName" name="floorName">
								<a-input v-model:value="formData.floorName" placeholder="请输入楼层名称"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="排序号" v-bind="validateInfos.sortOrder" id="ElderFloorForm-sortOrder" name="sortOrder">
