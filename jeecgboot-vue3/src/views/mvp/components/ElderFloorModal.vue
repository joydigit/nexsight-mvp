<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <ElderFloorForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></ElderFloorForm>
   <template #footer>
...
<script lang="ts" setup>
  ...
  import ElderFloorForm from './ElderFloorForm.vue'
