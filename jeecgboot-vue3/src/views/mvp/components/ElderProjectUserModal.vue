<template>
  <j-modal :title="title" maxHeight="500px" :width="800" :visible="visible" @ok="handleOk" :okButtonProps="{ class: { 'jee-hidden': disableSubmit } }" @cancel="handleCancel" cancelText="关闭">
    <ElderProjectUserForm ref="registerForm" @ok="submitCallback" :formDisabled="disableSubmit" :formBpm="false"></ElderProjectUserForm>
   <template #footer>
...
<script lang="ts" setup>
  ...
  import ElderProjectUserForm from './ElderProjectUserForm.vue'
